...
/**
 * This is the model class for table "generaleshijos".
 *
 * @property int $id
 ...
 */
class Generaleshijos extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['nombre', 'conquienvive'], 'string', 'max' => 50],
            [['escolaridad'], 'string', 'max' => 30],
