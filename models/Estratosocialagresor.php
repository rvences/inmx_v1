...
/**
 * This is the model class for table "estratosocialagresor".
 *
 * @property int $id
 ...
 * @property string $servidorpublico
 * @property string $servidorpublicocargo
 * @property string $servidorpublicioinstitucion
 ...
 */
class Estratosocialagresor extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['servidorpublico'], 'string', 'max' => 1],
            [['servidorpublicocargo', 'servidorpublicioinstitucion'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'servidorpublico' => '¿Servidor (a) público (a)?',
            'servidorpublicocargo' => 'Cargo',
            'servidorpublicioinstitucion' => 'Institución',
